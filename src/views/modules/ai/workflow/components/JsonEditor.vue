  ...
  <div class="json-editor">
    <div class="json-editor-header">
      ...
      <div class="json-actions">
        ...
        <a-button size="small" title="选择变量" type="text" @click="openVariableSelector">
          <template #icon>
            <FunctionOutlined />
          </template>
          变量
...
<script setup>
  ...
  const openVariableSelector = () => {
    tempValue.value = editorValue.value
